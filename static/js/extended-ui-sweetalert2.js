...
(function () {
  const basicAlert = document.querySelector('#basic-alert'),
    ...
    confirmTextCustomer = document.querySelector('#confirm-textCustomer'),
    ...
    htmlAlert.onclick = function () {
      Swal.fire({
        ...
        customClass: {
          ...
          cancelButton: 'btn btn-label-secondary btn-icon waves-effect'
        },
        buttonsStyling: false
      });
    };
        ...
        for (currentStep = 0; currentStep < steps.length; ) {
          const result = await new swalQueueStep({
            ...
            customClass: {
              ...
              denyButton: 'btn btn-label-secondary waves-effect'
            }
          });
  ...
  if (confirmText) {
    confirmText.onclick = function () {
      Swal.fire({
        title: '',
        text: 'از بستن زمان مطمئن هستید؟',
        icon: 'warning',
        showCancelButton: true,
        confirmButtonText: 'اتمام زمان',
    ...
    // Alert With Functional Confirm Button 2
  if (confirmTextCustomer) {
    confirmTextCustomer.onclick = function () {
      Swal.fire({
        title: '',
